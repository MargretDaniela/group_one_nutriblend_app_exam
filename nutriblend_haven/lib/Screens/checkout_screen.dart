...
class _CheckoutScreenState extends State<CheckoutScreen> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Delivery method toggle — two equal pill buttons
            Row(
              children: [
                Expanded(
                  child: Container(
            ...
            const SizedBox(height: 8),
            // Address text area (2 lines tall)
            Container(
              height: 80,
              width: double.infinity,
              decoration: BoxDecoration(
  ...
  Widget _buildDeliveryForm() {
    // While regions are loading on first open, show the full form shimmer
    if (_loadingRegions) return _buildFormShimmer();
